...
<html lang="en">
  ...
  <body>
    ...
    <main class="container mt-5 p-4">
      ...
      <h3 class="pageSubtitle mt-4">On-Campus Accommodations</h3>
      <p>
	On-campus accomodations consist of dormitory rooms (dorms)
	and a small number of hotel-style rooms at the Club &amp; Guest House.
	For attendees staying on campus, free shuttle bus service
        is available between here and the airport. In addition,
        parking is also available at no cost to attendees who
        reside on-site. A permit can be requested from the front
        desk upon arrival.
      </p>
      <p>
	Note that children under the age of 13 cannot stay in on-site
	accommodations, so those bringing younger children will
	...
	hotels.
	  ...
	  <p>
	    ...
	    university residence halls (dorms) for conference
	    attendees and their registered guests. These have shared bathrooms
	    for the floor.
          </p>
          <p>
	...
	<section class="col-lg-4 col-md-6 d-flex flex-column mt-4">
	  ...
	  <address>
	    <ul class="hotel-info">
              <li class="location">Building 581</li>
              <li>University of California</li>
	      <li>Santa Barbara, CA 93106</li>
              <li></li>
	      <li class="phone">(805) 893-7781</li>
	      <li class="email">simon.herrera@theclub.ucsb.edu</li>
	    </ul>
          </address>
          <p>
          ...
          <p>
	    Well-appointed guest rooms all come with lagoon and ocean
	    views and guests enjoy two complimentary deluxe
	    continental breakfasts. Conference meeting locations are
	    within a 5-minute walking distance from The Guest House.
	  </p>
	</section>
      </div>
      ...
      <p>
        ...
        <?php echo $META['shortName'];?>.  Note that none of the
        hotels is walking distance to the venue. Those who choose
        to stay off-site are responsible for making their own
        reservations. Early reservations are advised since August
        is a popular season in Santa Barbara.
      </p>
      <aside class="alert alert-warning">
	<img src="images/icons/exclamation.svg" class="icon" />&ensp;
	All prices are subject to change and do not include tax;
	prices should be confirmed by calling the hotels directly.
	Room blocks may be released as early as two months prior
	to the conference.  You must mention Crypto 2020 when you
	are making your reservations so you will be eligible for
	any special rates that may be available. Other hotels are
	...
	<section class="col-lg-4 col-md-6 d-flex flex-column mt-4">
	  ...
	  <address>
	    <ul class="hotel-info">
	      <li class="location">5620 Calle Real</li>
	      <li>Goleta, CA 93117</li>
	      <li></li>
	      <li class="phone">(805) 967-3200</li>
	      <li>Fax: (805) 683-4466</li>
	    </ul>
	  </address>
	  <p>
	  ...
	  <p>
	    Five minutes from the University; newly renovated. Breakfast
	    Buffet daily. Complimentary afternoon beverages Monday through
	    Thursday. Free local calls. Refrigerator, coffeemaker,
	    hairdryer and WI-FI for free internet access in all
	    rooms. Pool and spa. Morning and evening shuttle to UCSB and
	    airport 7:30am–10:00pm.
	  </p>
          <a class="btn btn-warning btn-block mt-auto" role="button"
	      href="https://www.hotelsone.com/goleta-hotels-us/best-western-plus-south-coast-inn.html?as=g&aid=47214591398&dsti=181877&dstt=8&akw=best%20western%20south%20coast%20inn&asrc=Search&ast=&gclid=EAIaIQobChMIraObleKC4wIVkP5kCh0ZfwAWEAAYAyAAEgKuSfD_BwE">Reservations</a>
	</section>
	<section class="col-lg-4 col-md-6 d-flex flex-column mt-4">
	  <h4 class="subSubtitle text-center">
	    Pacifica Suites
	  ...
	  <address>
	    <ul class="hotel-info">
	      <li class="location">5490 Hollister Ave</li>
	      <li>Goleta, CA 93111</li>
              <li></li>
	      <li class="phone">(805) 893-6722</li>
	      <li>Fax: (805) 683-4121</li>
	    </ul>
          </address>
          <p>
	    ...
	    breakfasts, two rooms, high-speed wireless internet, two TV’s,
	    microwave, stereo, refrigerator, pool and Jacuzzi. Complimentary
	    beverages served from 5-7pm. With 24-hour advance notice, will provide
	    shuttle service to and from the Santa Barbara Airport,
	    8:00am-5:00pm.
	  </p>
	  <a class="btn btn-warning btn-block mt-auto" role="button"
