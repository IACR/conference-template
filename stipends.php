    ...
    <main class="container mt-4 p-4">
      ...
      <div class="row">
        <section class="col-12">
          ...
          <!-- <p>
               The deadline for student stipend application is DATE. Please use "student stipend request" in the email subject.
               </p> -->
          <!-- <p>
               Notifications of stipends went out on DATE, but it's not too late! If you applied and didn't hear anything, send the general chair an email. We also have quite a few stipends still available for students at US universities, either undergraduate or graduate. Email the general chair.
               </p> -->
        </section>
      </div>
