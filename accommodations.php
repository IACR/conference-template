    ...
    <main class="container mt-5">
      ...
      <div class="row">
        <section class="col-sm-12">
          ...
          <ul class="list-group">
            <li class="list-group-item listItems col-sm-4">
              <h4 class="list-group-item-heading tableItemTitle text-center">
                Example Hotel #1
              </h4>
              <br />
            ...
            <li class="list-group-item listItems col-sm-4">
              ...
              <br />
              <a href="http://www.pacificasuites.com/" class="btn btn-warning btn-md btn-block hotelBtn" role="button">
